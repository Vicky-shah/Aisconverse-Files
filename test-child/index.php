    ...
    <div class="container">
        ...
        <div class="blog-section">
            ...
            <div class="blog-posts">
                <div class="blog-post">
                    <div class="post-img">
                        <img src="<?php echo get_template_directory_uri()?>/images/blog--img.jpg" alt="">
                    </div><!--post-img end-->
                    <div class="post-info">
                        <span class="posted-date">26, November 2019</span>
                        <p>More school leaders need to elevate the conversation that where students learn matters. Because when school leaders establish intentional school design.</p>
                    </div><!--post-info end-->
                </div><!--blog-post end-->
                <div class="blog-post">
                    <div class="post-img">
                        <img src="<?php echo get_template_directory_uri()?>/images/blog-img2.jpg" alt="">
                    </div><!--post-img end-->
                    <div class="post-info">
                        <span class="posted-date">20, November 2019</span>
                        <p>Growing the influence of student voice over the essential elements of teaching and learning has always been appealing for school leaders.</p>
                    </div><!--post-info end-->
                </div><!--blog-post end-->
            </div><!--blog-posts end-->
